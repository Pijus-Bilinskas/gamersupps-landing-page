...
const Drinkware = () => {
  return (
    <div>
        <h3 className='text-2xl md:text-5xl font-bold text-gray-100 text-center mb-12'>PREMIUM DRINKWARE</h3>
        ...
        <div className=' relative w-full mx-auto overflow-hidden'>
            ...
            <div className='bg-purple-800 py-5 gap-4 flex flex-row justify-center items-center'>
                <h3 className='text-gray-100 font-bold text-lg md:text-2xl'>BECOME A GG PARTNER</h3>
                <button className='text-gray-200 py-2 px-3 md:py-3 md:px-6 font-bold bg-gray-900'>LEARN MORE</button>
            </div>
        </div>
